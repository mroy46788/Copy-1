import { ChevronRight, Copy, Eye, Moon, Check, ChevronDown, Heart } from 'lucide-react';
...
export default function PromptDetail() {
  ...
  // Find the prompt by id, default to the first one if not found
  const prompt = prompts.find(p => String(p.id) === String(id)) || prompts[0];
  ...
  // Get 4 related prompts (excluding the current one)
