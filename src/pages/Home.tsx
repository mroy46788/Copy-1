...
export default function Home() {
  const latestPrompts = prompts.filter(p => p.isFeatured).slice(0, 6);
    ...
    <div className="max-w-7xl mx-auto px-8 py-16">
      ...
      <div className="text-center max-w-4xl mx-auto mb-24">
        <h1 className="text-5xl md:text-6xl font-bold text-white mb-8 tracking-tight leading-tight">
          Prompt Image - AI Art Gallery
        </h1>
        <p className="text-xl text-slate-400 mb-12 leading-relaxed">
          Discover and copy free AI art prompts. Browse our curated gallery of prompts for
        ...
        <div className="grid md:grid-cols-2 gap-16">
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/tutorials" className="px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white rounded-lg font-medium transition-colors border border-slate-700">
                Learn Prompting
              </Link>
