    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 flex flex-col">
          ...
          <button className="w-full py-4 bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-semibold transition-colors border border-slate-700">
            Get Started Free
          </button>
        </div>
        ...
        <div className="bg-gradient-to-b from-indigo-500/10 to-slate-900 border border-indigo-500/30 rounded-3xl p-8 relative flex flex-col shadow-2xl shadow-indigo-500/10">
          ...
          <button className="w-full py-4 bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl font-semibold transition-colors shadow-lg shadow-indigo-500/25 flex items-center justify-center gap-2">
